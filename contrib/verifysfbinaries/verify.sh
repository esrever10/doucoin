...
WORKINGDIR="/tmp/doucoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://doucoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://doucoin.org/bin/"
VERSIONPREFIX="doucoin-"
RCVERSIONSTRING="rc"
...
if [ $? -ne 0 ]; then
   ...
   echo "[doucoin-]<version>-[rc[0-9]] (example: doucoin-0.9.2-rc1)"
   echo "wget output:"
