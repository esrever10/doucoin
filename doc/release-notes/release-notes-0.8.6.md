Doucoin-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/doucoin/files/Doucoin/doucoin-0.8.6/
...
- Fix Doucoin-Qt startup crash when clicking dock icon on OSX 
...
Note: Gavin Andresen's GPG signing key for SHA256SUMS.asc has been changed from  key id 1FC730C1 to sub key 7BF6E212 (see https://github.com/doucoin/doucoin.org/pull/279).
