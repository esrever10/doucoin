Doucoin Core version 0.9.2.1 is now available from:

  https://doucoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DUC to 0.01 DUC
...
- Fix "Start doucoin on system login"
