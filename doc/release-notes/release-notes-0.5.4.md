Doucoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/doucoin/files/Doucoin/doucoin-0.5.4/
...
http://gitorious.org/doucoin/doucoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Doucoin-Qt notifications under Growl 1.3.
Increase required age of Doucoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDoucoin properly when installing Doucoin-Qt over it. (Windows)
