Doucoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/doucoin/files/Doucoin/doucoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Doucoin
...
New/changed settings (command-line or doucoin.conf file)
--------------------------------------------------------
