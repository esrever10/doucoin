Doucoin Core version 0.9.4 is now available from:

  https://doucoin.org/bin/0.9.4/
...
this update is incompatible with the Doucoin system and could lead to consensus
forks.

Doucoin Core released binaries from https://doucoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~doucoin/+archive/ubuntu/doucoin
- A third-party or self-compiled Doucoin Core

upgrade to Doucoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
