Download URL: https://sourceforge.net/projects/doucoin/files/Doucoin/doucoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 DUC fee schedule (users still pay 0.01 DUC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #doucoin00 - #doucoin99
