Doucoin Core version 0.13.2 is now available from:

  <https://doucoin.org/bin/doucoin-core-0.13.2/>
...
- #8908 `4a974b2` Update doucoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow doucoin-tx to create v2 transactions (ducdrak)
