...
This document provides guidelines for internationalization of the Doucoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `doucoin_en.ts` remains unchanged.
