Doucoin Core version 0.10.4 is now available from:

  <https://doucoin.org/bin/doucoin-core-0.10.4/>
...
- #6953 `43c2789` Split doucoin-tx into its own package
- #6953 `dfe0d4d` Include doucoin-tx binary on Debian/Ubuntu
