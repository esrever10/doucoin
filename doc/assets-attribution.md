The following is a list of assets used in the doucoin source and their proper attribution.
...
* License: MIT
* Site: [https://doucointalk.org/index.php?topic=15276.0](https://doucointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original doucoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/doucoin.icns, src/qt/res/src/doucoin.svg,
	src/qt/res/src/doucoin.ico, src/qt/res/src/doucoin.png,
	src/qt/res/src/doucoin_testnet.png, docs/doucoin_logo_doxygen.png,
