...
#if defined(NDEBUG)
# error "Doucoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Doucoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s DUC additional fees, %d delta bytes\n",
