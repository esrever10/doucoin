...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/doucoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Doucoin Core"),
     ...
     * override -datadir in the doucoin.conf file in the default data directory
     * (to be consistent with doucoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
