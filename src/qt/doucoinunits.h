...
#ifndef DOUCOIN_QT_DOUCOINUNITS_H
#define DOUCOIN_QT_DOUCOINUNITS_H
...
/** Doucoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DoucoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DoucoinUnits(QObject *parent);

    /** Doucoin units.
      @note Source: https://en.doucoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        DUC,
...
typedef DoucoinUnits::Unit DoucoinUnit;

#endif // DOUCOIN_QT_DOUCOINUNITS_H
