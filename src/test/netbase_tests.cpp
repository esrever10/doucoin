...
{
    BOOST_CHECK(TestSplitHost("www.doucoin.org", "www.doucoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.doucoin.org]", "www.doucoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.doucoin.org:80", "www.doucoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.doucoin.org]:80", "www.doucoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:23333", "127.0.0.1", 23333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:23333", "127.0.0.1", 23333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:23333", "::ffff:127.0.0.1", 23333));
    BOOST_CHECK(TestSplitHost("[::]:23333", "::", 23333));
    BOOST_CHECK(TestSplitHost("::23333", "::23333", -1));
    BOOST_CHECK(TestSplitHost(":23333", "", 23333));
    BOOST_CHECK(TestSplitHost("[]:23333", "", 23333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:23333", "127.0.0.1:23333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:23333", "[::]:23333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
