...
# Copyright 2016 The Doucoin Core developers
...
help_text="""Test framework for doucoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/doucoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "doucoin-util-test.json", buildenv)
