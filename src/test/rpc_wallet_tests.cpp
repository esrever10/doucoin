...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CDoucoinAddress demoAddress = CDoucoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CDoucoinAddress setaccountDemoAddress = CDoucoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CDoucoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CDoucoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
