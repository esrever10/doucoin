...
#ifndef DOUCOIN_TEST_SCRIPTNUM10_H
#define DOUCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Doucoin Core 0.10.0, for cross-comparison.
 */
public:
