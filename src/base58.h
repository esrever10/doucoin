...
public:
    ...
    CDoucoinExtKeyBase(const std::string& strBase58c) {
...
typedef CDoucoinExtKeyBase<CExtKey, BIP32_EXTKEY_SIZE, CChainParams::EXT_SECRET_KEY> CDoucoinExtKey;
typedef CDoucoinExtKeyBase<CExtPubKey, BIP32_EXTKEY_SIZE, CChainParams::EXT_PUBLIC_KEY> CDoucoinExtPubKey;
