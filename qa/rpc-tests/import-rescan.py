...
import RPC call and node 0 sends DUC to it. Then other nodes import the
...
In the second part of the test, node 0 sends more DUC to each address, and the
...
class ImportRescanTest(DoucoinTestFramework):
    def __init__(self):
        super().__init__()
