...
# TestNode: A peer we use to send messages to doucoind, and store responses.
...
class CompactBlocksTest(DoucoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes doucoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that doucoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for doucoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # doucoind will not send blocktxn responses for blocks whose height is
