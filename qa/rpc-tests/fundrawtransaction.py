...
class RawTransactionsTest(DoucoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid doucoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid doucoin address" in e.error['message'])
