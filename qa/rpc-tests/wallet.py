...
class WalletTest (DoucoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 DUC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 duc in block rewards plus fees, but
        ...
        # Send 10 DUC with subtract fee from amount
        ...
        # Sendmany 10 DUC with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/doucoin/doucoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
