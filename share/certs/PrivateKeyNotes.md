...
unlocked to sign the Doucoin-Qt.app bundle.
...
allowing somebody to distribute a Doucoin-Qt.app or doucoin-qt-setup.exe with a valid
...
that the doucoin-qt.exe file inside the installer had not been tampered with.
